          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <img 
                ...
                alt="ГАСА ГРУПП" 
                className="h-20 w-auto drop-shadow-lg hover:scale-110 cursor-pointer transition-transform"
                onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
              />
            </div>
            <nav className="hidden md:flex items-center gap-8" style={{fontFamily: '"Prosto One", sans-serif', fontWeight: 700}}>
              <a href="#projects" className="text-black hover:text-accent transition-colors text-lg uppercase">Проекты</a>
              <a href="#portfolio" className="text-black hover:text-accent transition-colors text-lg uppercase">Портфолио</a>
              <a href="#services" className="text-black hover:text-accent transition-colors text-lg uppercase">Услуги</a>
              <a href="#advantages" className="text-black hover:text-accent transition-colors text-lg uppercase">Преимущества</a>
              <a href="#contact" className="text-black hover:text-accent transition-colors text-lg uppercase">Контакты</a>
            </nav>
            <div className="flex items-center gap-4">
              <a href="tel:+79398818942">
                <Button className="hidden md:flex bg-accent hover:bg-accent/90 text-accent-foreground rounded-full px-6 shadow-md hover:shadow-lg transition-all text-base" style={{fontFamily: '"Prosto One", sans-serif', fontWeight: 700}}>
                  <Icon name="Phone" size={20} className="mr-2" />
                  <span className="uppercase">Звонок</span>
                </Button>
              </a>
              <Button 
                variant="ghost" 
